...
const FeaturedJobs = () => {
  const jobCards = [
    ...
    { title: "Maketing Manager", company: "Tesla", salary: "$150,000/y", location: "Pal Alto, US", logo: require('../assets/amazon.png') },
    { title: "UX Designer", company: "Apple", salary: "$150,000/y", location: "Cupertino, US", logo: require('../assets/amazon.png') },
    { title: "Data Scientist", company: "Microsoft", salary: "$140,000/y", location: "Redmond, US", logo: require('../assets/amazon.png') },
